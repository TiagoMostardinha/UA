// Generated from /home/tiago/DiscoD/UA/C/P/src/redo/ex3/Calculator.g4 by ANTLR 4.9.2
...
public class CalculatorParser extends Parser {
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << T__1) | (1L << T__5) | (1L << INT) | (1L << NEWLINE))) != 0)) {
				{
				{
				setState(6);
				stat();
	...
	public final StatContext stat() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << T__1) | (1L << T__5) | (1L << INT))) != 0)) {
				{
				setState(14);
				expr(0);
				}
