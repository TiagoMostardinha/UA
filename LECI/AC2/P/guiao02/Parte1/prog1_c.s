...
# 1hz:    blt      $v0, 200000, while   #    while(readCoreTimer() < 200 000);
# 5hz:    blt      $v0, 4000000, while  #    while(readCoreTimer() < 4 000 000);
  10hz:    blt     $v0, 2000000, while  #    while(readCoreTimer() < 2 000 000);
