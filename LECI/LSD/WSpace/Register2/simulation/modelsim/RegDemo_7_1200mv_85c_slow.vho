...
ARCHITECTURE structure OF Reg_Test IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
SIGNAL \reg|dout[0]~feeder_combout\ : std_logic;
...
SIGNAL \reg|dout\ : std_logic_vector(4 DOWNTO 0);
...
\reg|dout[0]~feeder\ : cycloneive_lcell_comb
-- Equation(s):
-- \reg|dout[0]~feeder_combout\ = \SW[0]~input_o\
...
PORT MAP (
	datad => \SW[0]~input_o\,
	combout => \reg|dout[0]~feeder_combout\);

-- Location: FF_X114_Y68_N1
\reg|dout[0]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
...
-- Equation(s):
-- \reg|dout[1]~feeder_combout\ = \SW[1]~input_o\
...
-- Equation(s):
-- \reg|dout[4]~feeder_combout\ = \SW[4]~input_o\
