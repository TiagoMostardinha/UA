...
loop:                               # while(1)
    ...
    andi    $t1,$t1,0x0001          #   $t1 = RB0       -> configure PORTB0 as an input, by forcing the bit 0 being "1"

    lw      $t2,LATE($t0)           #   $t2 = [LATE]
    andi    $t2,$t2,0xFFFE          #   #t2 = RE0       -> configure LATE0 as an output, by forcing the bit 0 being "0"

    xor     $t1,$t1,0x0001          #   $t1 = /RE0
