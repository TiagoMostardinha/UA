...
typedef struct
{
   ...
   pthread_mutex_t mutex;           // mutex for the FIFO
   pthread_cond_t notEmpty;         // condition variable for FIFO not empty
   pthread_cond_t notFull;          // condition variable for FIFO not full
} PriorityFIFO;
